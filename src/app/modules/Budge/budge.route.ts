...
router.post("/", validateUser(UserRole.ADMIN), validateRequest(createBudgetSchema), budgetController.createBudget)
...
router.patch("/:id", validateUser(UserRole.ADMIN), budgetController.updateBudget)
router.delete("/:id", validateUser(UserRole.ADMIN), budgetController.deleteBudget)
